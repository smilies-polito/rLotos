...
class PalacellEnv():
  ...
  def _get_info(self):
    ...
    lc = "last cell num: "+str(self.last_cell_num)+", best least iterations num: "+str(self.least_iterations)+", best cell num: "+str(self.best_cell_num)
    io = "last inside-outside: "+str(self.last_inside_outside)+", best last inside-outside: "+str(self.best_inside_outside)
    lc = lc+" elapsed time: "+str(time.time()-self.start_time)+" iteration: "+str(self.iteration_num)+" iters: "+str(self.iters)
    io = io+" elapsed time: "+str(time.time()-self.start_time)+" iteration: "+str(self.iteration_num)+" iters: "+str(self.iters)
    return st, io
